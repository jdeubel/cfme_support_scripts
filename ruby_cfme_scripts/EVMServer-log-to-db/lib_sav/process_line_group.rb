...
$Id: process_line_group.rb 16987 2009-11-05 14:25:21Z thennessy $
=end
...
#        $active_processes.delete(pid)
     ...
     $active_processes[$Parsed_log_line.log_pid] = {"PID" => $Parsed_log_line.log_pid ,
       ...
       "last heard from" => $Parsed_log_line.log_datetime_string , "last heard from seconds" => $Parsed_log_line.log_datetime,
       "process type" => nil,
