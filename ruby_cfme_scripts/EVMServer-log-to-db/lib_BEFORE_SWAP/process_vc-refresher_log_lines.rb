...
$Id: process_vc-refresher_log_lines.rb 16597 2009-10-12 15:36:47Z thennessy $
=end
$Hosts = Hash.new
$VMs = Hash.new
$Folders = Hash.new
...
#  if /Updating Storage/ =~ log_line then
...
#               "parsed_log_line ->#{$Parsed_log_line.inspect}"
  ...
  when /EmsRefreshHelper/ then                         #just skip any processing for this one
