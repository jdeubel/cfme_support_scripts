...
$Id: process_line_group.rb 20976 2010-05-17 19:12:54Z thennessy $
=end
def process_line_group(line_group_in)
#    if /\- Count\:/ =~ line_group_in[0] then
#      puts "#{__FILE__}:#{__LINE__}=>#{line_group_in[0]}"
#  end
#      if /undefined method \`capture_rt_performance\'/ =~ line_group_in[0] then
#    puts "#{__FILE__}:#{__LINE__}=>#{line_group_in[0]}"
#  end
#
