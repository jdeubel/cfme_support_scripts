...
=end
require "dictionary"
$large_integer = Dictionary.new
$msg_server_guid = Dictionary.new
$msg_server_host = Dictionary.new
$msg_processing_status = Dictionary.new
$msg_ident_id = Dictionary.new
$msg_task_id = Dictionary.new
$msg_method_name = Dictionary.new
$msg_data_store = Dictionary.new
$msg_data_msg_cmd = Dictionary.new
$msg_class_name = Dictionary.new
$msg_error_text = Dictionary.new
$msg_role = Dictionary.new
$msg_zone = Dictionary.new
$msg_args = Dictionary.new
