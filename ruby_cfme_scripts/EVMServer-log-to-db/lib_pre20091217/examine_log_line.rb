...
$Id: examine_log_line.rb 17490 2009-12-02 20:38:41Z thennessy $
=end
...
#        _worker_part2_array = _worker_part2.split(",")
     ...
     $active_processes[_worker_stats_hash["worker_pid"]] = {"PID" => _worker_stats_hash["worker_pid"] ,
       ...
       "last heard from" => $Parsed_log_line.log_datetime_string.split(".")[0] , "last heart from seconds" => $Parsed_log_line.log_datetime,
