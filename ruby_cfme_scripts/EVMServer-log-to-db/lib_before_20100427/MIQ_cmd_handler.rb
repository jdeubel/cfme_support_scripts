=begin rdoc
$Id: MIQ_cmd_handler.rb 20352 2010-04-16 02:53:24Z thennessy $
...
#Message id: [82], Class name: [EmsEvent], Instance id: [], Method name: [add], Task id: [] saved queue entry          
        ...
        when /Message id:\s*\[(\S*)\]/ then log_msg_info_instance.msg_id = $1 if $1 != nil
        ...
        when /Method name:\s*\[(\S*)\]/ then log_msg_info_instance.msg_method_name = $1 if $1 != nil
