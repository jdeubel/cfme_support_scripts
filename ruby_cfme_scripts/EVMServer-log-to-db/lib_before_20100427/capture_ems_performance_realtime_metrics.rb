...
$Id: capture_ems_performance_realtime_metrics.rb 20352 2010-04-16 02:53:24Z thennessy $
=end
...
attr_accessor :vim_execute_time, :map_mors_to_intervals, :db_processing, :log_datetime, :running_vm_count,:perf_processing, :pid
...
#                      @accumulated_times += @num_vim_queries
                    ...
                    when /map_mors_to_intervals/ then 
                      @map_mors_to_intervals = fragment.split[1].to_f
                      @accumulated_times += @map_mors_to_intervals
