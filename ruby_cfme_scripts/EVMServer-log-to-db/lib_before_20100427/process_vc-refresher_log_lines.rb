...
$Id: process_vc-refresher_log_lines.rb 20083 2010-04-01 02:50:15Z thennessy $
=end
$Hosts = Hash.new
$VMs = Hash.new
$Folders = Hash.new
...
class EMS_inventory
  attr_accessor :emsname, :server_guid, :server_name, :inventory_type, :count, :log_time, :startup, :pid
  @emsname == nil
  @server_guid = nil
  @server_name = nil
  @inventory_type = nil
