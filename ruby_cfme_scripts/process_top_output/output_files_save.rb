...
#    process_detail_stats = File.new("process_details.csv","w")
    fileout.puts "time of day,pid,user,pr,ni,virt,res,shr,s,cpu,mem,time,command,elapsed time"
  end
  fileout.puts "#{x.join(",")}"
end
...
#    process_detail_stats = File.new("process_details.csv","w")
    fileout.puts "server guid,server hostname,appliance name,time of day,pid,user,pr,ni,virt,res,shr,s,cpu,mem,time,command,elapsed time"
  end
