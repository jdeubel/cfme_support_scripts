...
#      exit
    ...
    if linein_array.size < 12 then               #make sure there are at least 12 elements in detail array or there is an error and just skip it
      puts "Bad top line is '#{linein}'"
      next
    end
